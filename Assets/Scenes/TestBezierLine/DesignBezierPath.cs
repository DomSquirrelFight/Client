...
public class DesignBezierPath : MonoBehaviour {
    ...
    void OnDrawGizmos()
    {
       // Vector3 draw = gameObject.transform.TransformPoint(m_vPoints[PointNum - 1]);
       for(int i=0;i<PointNum;i++)
        {
            Vector3 draw = gameObject.transform.TransformPoint(m_vPoints[i]);
            Gizmos.DrawSphere(draw, 0.2f);
        }
