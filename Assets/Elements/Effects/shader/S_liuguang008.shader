...
////// Emissive:
                ...
                float2 node_9232 = (i.uv0+node_999.g*float2(0.1,0.1));
                ...
                float2 node_1655 = ((i.uv0+node_3741)+node_999.g*float2(-0.1,0));
                float4 _wenli02_var = tex2D(_wenli02,TRANSFORM_TEX(node_1655, _wenli02));
                float3 emissive = (i.vertexColor.a*((_node_4694.rgb*_wenli01_var.r)*pow((float3(2,3,4)*_wenli02_var.r),1.5)*_qiangdu));
