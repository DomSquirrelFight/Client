...
////// Lighting:
////// Emissive:
                float4 node_2300 = _Time + _TimeEditor;
                float node_410_ang = node_2300.g;
                ...
                float2 node_9232 = (i.uv0+node_2300.g*float2(0.1,0.1));
                ...
                float2 node_1655 = ((i.uv0+node_3741)+node_2300.g*float2(0.3,0));
                ...
                float3 emissive = (i.vertexColor.rgb*((_wenli01_var.r*pow((_color02.rgb*_wenli02_var.r),1.5)*_qiangdu)+(_node_6958_var.rgb*0.5))*_Xiaosang_var.rgb*i.vertexColor.a);
